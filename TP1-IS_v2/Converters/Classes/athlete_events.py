...
#EXREVE OS DADOS DE UM ATLETA
    def convert_toXML(self):
        ...
        </atlethe>""" % (self.name, self.sex, self.age, self.height, self.weight, self.team, self.noc, self.games, self.year, self.season, self.city, self.sport, self.event, self.medal)